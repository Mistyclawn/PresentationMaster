...
출발은 나의 불편에서부터 시작됩니다. 발표 자료를 만들 때마다 슬라이드 디자인과 발표 스크립트를 별도로 관리하는 것이 번거로웠고, 디자인 일관성을 유지하는 것도 어려웠습니다. 또한, 인터넷 연결이 불안정한 환경에서도 작업할 수 있는 오프라인 도구가 필요했습니다... 캔바는 왜 지원하지 않는거야? 싶은 불만과 짜증, 그리고 발표 연습을 위한 통합 솔루션의 부재까지. 이러한 문제들을 해결하기 위해 **PPTXManager**를 기획하게 되었습니다.
