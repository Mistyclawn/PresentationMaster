        ...
        <header className="editor-header">
            ...
            <div className="header-top">
                <div className="header-title-area">
                    {/* Unified Left Section: Icon -> Title -> Status */}
                    ...
                    {mode === 'editor' ? (
                        ...
                        <div className="app-icon" style={{ backgroundColor: 'var(--color-primary-light)', color: 'var(--color-primary)' }}>
                ...
                <div className="header-actions">
                    ...
                    {/* Common Actions: Help & Settings (Now on all screens) */}
                    ...
                    {/* Editor Profile is usually last, keeping it consistent */}
